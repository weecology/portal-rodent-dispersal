...
points(dmyr, dmmo, pch = 19, col = "hotpink")
textxy(dmyr, dmmo, "DM")
points(peyr, pemo, pch = 19, col = "blue")
textxy(peyr, pemo, "PE")
points(pmyr, pmmo, pch = 19, col = "blue")
textxy(pmyr, pmmo, "PM")
points(rmyr, rmmo, pch = 19, col = "blue")
textxy(rmyr, rmmo, "RM")
points(otyr, otmo, pch = 19, cex = 1.5, col = "brown")
textxy(otyr, otmo, "OT")
points(olyr, olmo, pch = 19, cex = 1.5, col = "brown")
textxy(olyr, olmo, "OT")
points(shyr, shmo, pch = 19, col = "chartreuse3")
textxy(shyr, shmo, "SH")
points(sfyr, sfmo, pch = 19, col = "chartreuse3")
textxy(sfyr, sfmo, "SH")
points(naoyr, naomo, pch = 19, col = "chartreuse3")
textxy(naoyr, naomo, "NA")
abline(v = 0.5, lty = 2, col = 'gray40', lwd = 1)
abline(h = 0.5, lty = 2, col = 'gray40', lwd = 1)

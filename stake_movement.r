...
DO_MARK = noplacelikehome(subset(het, species == "DO"), periods, krat_excl, allbrk)
DM_MARK = noplacelikehome(subset(het, species == "DM"), periods, krat_excl, allbrk)
PB_MARK = noplacelikehome(subset(het, species == "PB"), periods, exclosures, allbrk)
PP_MARK = noplacelikehome(subset(het, species == "PP"), periods, exclosures, allbrk)
PF_MARK = noplacelikehome(subset(het, species == "PF"), periods, exclosures, allbrk)
                          
PE_MARK = noplacelikehome(subset(cricet, species == "PE"), periods, exclosures, allbrk) 
PM_MARK = noplacelikehome(subset(cricet, species == "PM"), periods, exclosures, allbrk)
RM_MARK = noplacelikehome(subset(cricet, species == "RM"), periods, exclosures, allbrk)
                          
SH_MARK = noplacelikehome(subset(foliv, species == "SH"), periods, exclosures, allbrk)
SF_MARK = noplacelikehome(subset(foliv, species == "SF"), periods, exclosures, allbrk)
NAO_MARK = noplacelikehome(subset(foliv, species == "NAO"), periods, exclosures, allbrk)
                          
OT_MARK = noplacelikehome(subset(insec, species == "OT"), periods, exclosures, allbrk)
OL_MARK = noplacelikehome(subset(insec, species == "OL"), periods, exclosures, allbrk)
